...
class AffectationEtudiant extends Component
{
         ...
         <div className="container-fluid">
           <div className="row mb-2">
             <div className="col-sm-6">
               <h1 className="m-0 text-dark">Affecter un étudiant à une Formation</h1>
             </div>{/* /.col */}
             <div className="col-sm-6">
               <ol className="breadcrumb float-sm-right">
                 <li className="breadcrumb-item"><a href="#">Gestion des étudiants</a></li>
                 <li className="breadcrumb-item active">Affectation d'un étudiant</li>
               </ol>
             </div>{/* /.col */}
           </div>{/* /.row */}
         </div>{/* /.container-fluid */}
